<header>
	<div class="container">
        ...
        <a class="navbar-brand" href="index.php"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-bookmark-star" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
          <ul class="navbar-nav mr-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link" href="index.php?n=member">Your Profile</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="index.php?n=information">SCR Information</a>
            </li>
          </ul>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <li><a class="dropdown-item" href="index.php?n=admin_terms">Terms</a></li>
								<li><a class="dropdown-item" href="index.php?n=admin_logs">Logs</a></li>
								<li><a class="dropdown-item" href="index.php?n=admin_settings">Site Settings</a></li>
