...
require_once(_ZAPCAL_BASE . '/calendar/date.php');
require_once(_ZAPCAL_BASE . '/calendar/recurringdate.php');
require_once(_ZAPCAL_BASE . '/calendar/ical.php');
require_once(_ZAPCAL_BASE . '/calendar/timezone.php');
